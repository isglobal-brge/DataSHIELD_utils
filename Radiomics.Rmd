...
![Imagen de un pulmón mediante CT Scan](C:/Iker/ISGlobal/Radiomics_data/ct_lung.png)


Calcular las Radiomic features para diez indiv
...
```{r, eval = TRUE}
rdr <- import_radiomic_table(file = "C:/Iker/ISGlobal/Radiomics_data/stats_global.tsv")
```
Crear una tabla con las características para cada individuo
